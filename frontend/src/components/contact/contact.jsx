    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font12">
            Need a reliable ride in Mayiladuthurai? Family OLA taxi tours & Droptaxi. is here for you — 24/7 local and outstation services with experienced drivers and clean vehicles. Use the form below or call us directly for quick bookings and enquiries.
          </p>
